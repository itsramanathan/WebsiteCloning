...
The final Node 25.6.1 run passed 29 Node tests plus the real Chromium browser regression.

The suite is intentionally local and deterministic. It covers:

- split-hero retail, hero-less B2B, metadata-only hero rejection, visible hero-image preference, and compact catalog/sidebar fixtures; full evidenced titles; unknown facts; retained stylesheet failures; no-catalog failure; detail enrichment; and page/product/asset bounds;
